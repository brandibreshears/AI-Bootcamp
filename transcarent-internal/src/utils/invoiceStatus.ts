...
): 'success' | 'info' | 'warning' | 'error' | 'neutral' | 'noCost' | 'disabled' | 'discarded' | 'waived' | 'included' | 'refundRequested' | 'refundFailed' | 'refundApproved' | 'refundPending' | 'refundIssued' | 'refundDeclined' {
  switch (state) {
    ...
    case 'no_cost': return 'noCost';
    case 'disabled': return 'disabled';
    case 'discarded': return 'discarded';
    case 'waived': return 'waived';
    case 'included': return 'included';
    case 'refund_requested': return 'refundRequested';
    case 'refund_failed': return 'refundFailed';
    case 'refund_approved': return 'refundApproved';
    case 'refund_pending': return 'refundPending';
    case 'refund_issued': return 'refundIssued';
    case 'refund_declined': return 'refundDeclined';
